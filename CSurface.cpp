...
//******************************
SDL_Surface* CSurface::loadSursface(char* fname, SDL_Surface* screen)
{
...
//*******************************
SDL_Surface* CSurface::loadSursface(char* fname, SDL_Surface* screen,int r, int g, int b)
{
    SDL_Surface* temp = SDL_LoadBMP(fname);
    if(temp == NULL)
    {
...
void CSurface::drawSurface(SDL_Surface* src, SDL_Surface* dst,SDL_Rect* clip, SDL_Rect* scale)
{
    ...
    SDL_BlitSurface(src,NULL,dst,scale);
}
//************************************
